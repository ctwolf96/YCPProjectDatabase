...
private IDatabase db;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		SolicitationType solicitationType = getSolicitTypeFromParameter(req.getParameter("solicitationType"));
		ArrayList<MajorType> majors=null;
		ArrayList<ClassType> classes=null; 
