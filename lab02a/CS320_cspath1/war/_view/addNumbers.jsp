	...
	<form action="${pageContext.servletContext.contextPath}/addNumbers"
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="second" size="12"
					value="${second}" /></td>
			</tr>
			<tr>
		...
		<input name="first" type="hidden" value="${first}" /> <input
			name="second" type="hidden" value="${second}" /> <input name="third"
			type="hidden" value="${third}" /> <input type="Submit" name="submit"
			value="Add Numbers!">
	</form>
