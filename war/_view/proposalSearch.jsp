...
<header>
	...
	<body>
		...
		<div class="superContainer">
			<form
				action="${pageContext.servletContext.contextPath}/proposalSearch"
				method="post">
				...
				<br> <label><a>Deadline:</a></label><br> <input
					type="date" name="deadline"><br>
				...
				<br> <label><a>Student Year(s)</a></label><br> <input
					type="checkbox" name="freshman" value="Freshman">Freshman <input
					type="checkbox" name="sophomore" value="Sophomore">Sophomore
