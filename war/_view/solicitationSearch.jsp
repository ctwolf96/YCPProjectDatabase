...
<header>
	...
	<body>
		...
		<div class="superContainer">
			<form
				action="${pageContext.servletContext.contextPath}/solicitationSearch"
				method="post">
				<h1 style="text-align: center">Solicited Project Search</h1>
				<p>Select a field to search by and click "Search"</p>
				<br> <label><a>Project Title:</a></label><br> <input
				...
				<br> <label><a>Start Date:</a></label><br> <input
					type="date" name="startDate"><br>
				<br> <label><a>Majors/Disciplines:</a></label><br> <input
				...
				<input type="checkbox" name="ME" value="ME">Mechanical
				Engineering <input type="checkbox" name="CivE" value="CivE">Civil
				Engineering <br> <label><a>Student Year(s):</a></label><br>
				<input type="checkbox" name="freshman" value="Freshman">Freshman
				<input type="checkbox" name="sophomore" value="Sophomore">Sophomore
				<input type="checkbox" name="junior" value="Junior">Junior <input
					type="checkbox" name="senior" value="Senior">Senior <br>

				<label><a>Solicitation Type:</a></label><br> <select>
					...
					<br>
						...
						<label><a>Number of Students:</a></label>
					<br>
						<input type="text" name="numStudents">
					<br>
					<br>

						<label><a>Cost:</a></label>
					<br>
