...
<title>Login</title>
<meta name="viewport"
	content-type="width = device-width initial-scale =1">
</head>
<body>
	<div id="header">
		<div id="logo">
	...
	<div class="container">
		<form action="${pageContext.servletContext.contextPath}/login"
			...
			<div style="margin-left: 23px">
				<input type="Submit" class="button5 button" name="submit"
					value="Login"> <input name="SignUp" type="Submit"
					class="button5 button" name="submit" value="Sign Up">
			</div>
		</form>
