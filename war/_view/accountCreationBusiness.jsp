		...
		<div class="container">
			...
			<table style="margin: 10px">
				<tr>
					...
					<td><input type="text" placeholder="Business Name" name="name" size="12" value="${model.businessName}" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" placeholder="Phone Number" name="number" size="12" value="${model.phone}" /></td>
				</tr>
